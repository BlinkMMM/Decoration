...
public class CostServiceImpl implements CostService{
	...
	public ModelAndView findTotalCost(String searchName) {
		ModelAndView mv = new ModelAndView();
		Map<String,Object> map = this.checkSearchName(searchName);
		List<Project> projectList = projectDao.findAllProjectByCondition(map);
		List<TotalCostBean> totalCostList = new ArrayList<>();
	...
	private double getAllWageCOst(String projectName){
	...
	private TotalCostBean getTotalCost(Project project){
		...
		double totalCost = allWageCost + allMatCost;
		return new TotalCostBean(allMatCost, allWageCost, totalCost, project);
		
	}
	
	private Map<String,Object> checkSearchName(String searchName){

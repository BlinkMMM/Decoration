  ...
  <div class="body-content">
    <form method="post" class="form-x" action="schedule/saveSchedule">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="scheduleProject.projectName" data-validate="required:请输入项目名"/>
        </div>
      </div>
            <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="scheduleFlow.flowName" data-validate="required:请输入流程名称"/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">

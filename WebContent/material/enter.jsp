...
<body>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 材料进场</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="enter/addInfo"> 新添进场材料</a> </li>
        <form method="post" action="enter/matSearch">
    ...
    <table class="table table-hover text-center">
     ...
     <form method="post" action="enter/pageNumber" id="listform">
      ...
      <tr>
			<td colspan="8">
				<div class="pagelist" style="display:inline-block;">
					<a href="<%=path%>/enter/?enterFrom=firstPage">首页</a> 
					<a href="<%=path%>/enter/?enterFrom=previousPage">上一页</a> 
					<a href="<%=path%>/enter/?enterFrom=nextPage">下一页</a> 
					<a href="<%=path%>/enter/?enterFrom=finalPage">尾页</a>
				</div>
				<div style="display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;当前页数</div>
				
					<div style="display:inline-block;">
						<select name="currentPageCode" class="input" style="width: 100px; line-height: 15px;">
							<c:forEach var="i" begin="1" end="${enterPage.totalPages }" varStatus="rowCount">
							<c:if test="${i == enterPage.currentPageCode}">
